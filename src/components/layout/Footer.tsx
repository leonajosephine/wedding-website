...
export function Footer() {
  ...
  return (
    <footer className="bg-[var(--text)] px-6 py-14 text-center text-[rgba(252,245,234,0.68)]">
      <div className="script mb-3 text-3xl text-[var(--olive-light)] md:text-5xl">
        Merle <span className="ampersand text-[var(--olive-light)]">& </span>
         Lasse
      </div>
      ...
      <a
        href={`mailto:${t('email')}`}
        className="text-sm text-[var(--olive-light)] transition-colors hover:text-[var(--background)]"
      >
        {t('cta')}
      </a>
    </footer>
